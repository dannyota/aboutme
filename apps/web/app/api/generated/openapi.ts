...
export interface components {
    schemas: {
        ...
        Capabilities: {
            /** @description At least one provider's login and linking routes are registered; true exactly when `providers` is non-empty. */
            providerLogin: boolean;
            /** @description The providers whose login and linking routes are registered, in the fixed order google, github, linkedin. Empty for a password-only deployment. */
