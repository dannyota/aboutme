...
// Paths come from Simple Icons 16.31.0 (CC0-1.0), recorded in
// THIRD_PARTY_NOTICES.md. LinkedIn has no CC0 mark there, so it keeps the
// generic link glyph (docs/adr/0041-contact-link-display-and-body-justify.md).
...
const brandIcon = (name: string, path: string) => defineComponent({
  name: `Brand${name}`,
