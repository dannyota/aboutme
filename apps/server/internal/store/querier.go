...
type Querier interface {
	...
	RuntimeActivateReplicaCapacity(ctx context.Context, arg RuntimeActivateReplicaCapacityParams) (RuntimeActivateReplicaCapacityRow, error)
	RuntimeAdmitSlugChange(ctx context.Context, keyDigest []byte) (RuntimeAdmitSlugChangeRow, error)
	RuntimeAdmitTokenRate(ctx context.Context, arg RuntimeAdmitTokenRateParams) (RuntimeAdmitTokenRateRow, error)
	RuntimeBeginReplicaTermination(ctx context.Context, arg RuntimeBeginReplicaTerminationParams) (RuntimeBeginReplicaTerminationRow, error)
	RuntimeCleanupAdmissionAttemptReceipts(ctx context.Context, pageSize int32) (int32, error)
	RuntimeCleanupRateBuckets(ctx context.Context, arg RuntimeCleanupRateBucketsParams) (RuntimeCleanupRateBucketsRow, error)
	RuntimeClearPasswordFailure(ctx context.Context, keyDigest []byte) (RuntimeClearPasswordFailureRow, error)
	RuntimeFinishAdmissionAttempt(ctx context.Context, arg RuntimeFinishAdmissionAttemptParams) (RuntimeFinishAdmissionAttemptRow, error)
	RuntimeFinishMaintenanceGracefulLeave(ctx context.Context, arg RuntimeFinishMaintenanceGracefulLeaveParams) (RuntimeFinishMaintenanceGracefulLeaveRow, error)
	RuntimeFinishScaleIn(ctx context.Context, arg RuntimeFinishScaleInParams) (RuntimeFinishScaleInRow, error)
	RuntimeFinishServingGracefulLeave(ctx context.Context, arg RuntimeFinishServingGracefulLeaveParams) (RuntimeFinishServingGracefulLeaveRow, error)
	...
	RuntimePasswordFailureState(ctx context.Context, keyDigest []byte) (RuntimePasswordFailureStateRow, error)
	RuntimePrepareMaintenanceDrain(ctx context.Context, arg RuntimePrepareMaintenanceDrainParams) (RuntimePrepareMaintenanceDrainRow, error)
	RuntimePrepareScaleIn(ctx context.Context, arg RuntimePrepareScaleInParams) (RuntimePrepareScaleInRow, error)
	RuntimePrepareScaleOut(ctx context.Context, arg RuntimePrepareScaleOutParams) (RuntimePrepareScaleOutRow, error)
	RuntimePromoteClaim(ctx context.Context, arg RuntimePromoteClaimParams) (RuntimePromoteClaimRow, error)
	RuntimeRecordEC2Termination(ctx context.Context, arg RuntimeRecordEC2TerminationParams) (RuntimeRecordEC2TerminationRow, error)
	RuntimeRecordPasswordFailure(ctx context.Context, keyDigest []byte) (RuntimeRecordPasswordFailureRow, error)
	...
	RuntimeReserveOAuthFailedGrant(ctx context.Context, arg RuntimeReserveOAuthFailedGrantParams) (RuntimeReserveOAuthFailedGrantRow, error)
