...
func TestMarkdownEveryContactEntryAndDateFormGolden(t *testing.T) {
	...
	resume := publicresume.PublicResume{Document: publicresume.PublicResumeDocument{
		...
		Content: publicresume.PublicContent{
			...
			"project":     {SectionType: "project", DisplayName: ptr("Projects"), ProjectEntries: []publicresume.PublicProjectEntry{{ID: "1", Title: ptr("Project"), Link: ptr("https://project.test"), Subtitle: ptr("Project *stack*"), Dates: &publicresume.PublicDateRange{Start: publicresume.PublicYearMonth{Y: 2006}, End: &publicresume.PublicYearMonth{Y: 2007}}, Description: ptr("Project body")}}},
