...
# Once the comparison base contains .uat-baseline, the marker and every
# migration already present on that base are immutable; only new migration
# files may be added. A base without the marker allows edits.
set -Eeuo pipefail
