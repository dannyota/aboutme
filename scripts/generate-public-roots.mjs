...
const registryRelativePath = "packages/publicroots/public-roots.v5.json";
...
export function parsePublicRoots(raw) {
  ...
  if (!Number.isInteger(value.version) || value.version !== 5) {
    throw new Error("public roots registry version must be integer 5");
  }
  if (
