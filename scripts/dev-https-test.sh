...
[ "$2" = --check ]
[ -f "$PWD/packages/publicroots/public-roots.v7.json" ]
[ -f "$PWD/deploy/caddy/public-roots.generated.caddy" ]
[ "$(sha256sum "$PWD/packages/publicroots/public-roots.v7.json" | awk '{print $1}')" = "$FAKE_REGISTRY_SHA256" ]
...
new_fixture() {
  ...
  cp "$SOURCE_ROOT/packages/publicroots/public-roots.v7.json" "$fixture/repo/packages/publicroots/public-roots.v7.json"
...
fixture_env() {
  ...
  export FAKE_REGISTRY_SHA256=$(sha256sum "$fixture/repo/packages/publicroots/public-roots.v7.json" | awk '{print $1}')
