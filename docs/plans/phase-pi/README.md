...
AC-INF-001…008 (PI-owned) and AC-OPS-015…019 (P9A-owned) are recorded directly
in [`traceability/`](../traceability/); PI sequencing and status are recorded
...
This plan was split from a single `phase-pi-infrastructure.md` file; the text of
each section is unchanged.

| File                                                                                 | Contents                                                                                                            |
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------- |
| [`constraints.md`](constraints.md)                                                   | Environment facts (verified 2026-08-02 at `9382c86`); global constraints                                            |
| [`decisions.md`](decisions.md)                                                       | Design decisions D1–D25 this plan makes beyond the spec                                                             |
...
| [`task-03-database-storage-modules.md`](task-03-database-storage-modules.md)         | Task 3: Database + storage modules — RDS gp3 (private subnets), S3 media                                            |
| [`task-04-secrets-iam-module.md`](task-04-secrets-iam-module.md)                     | Task 4: Secrets & IAM module — SSM contract, scoped roles, bootstrap script                                         |
...
| [`task-06-edge-module.md`](task-06-edge-module.md)                                   | Task 6: Edge module — CloudFront behavior matrix, ORPs, HSTS, staging gate, ACM                                     |
