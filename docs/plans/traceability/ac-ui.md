...
| AC-UI-012 | Publish controls; ADR 0030 motion          | Publish success shows the stamp with the canonical link and Copy link; the title mark appears in one press and instantly under reduced motion                                                                    | PV T09     | PLANNED | Pending                     |
