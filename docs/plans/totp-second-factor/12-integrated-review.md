...
Review the complete v0.4.7 release once after the manager verifies every author
...
- Confirm flags, mixed versions, older-client failure, floor 4007, lower-target
