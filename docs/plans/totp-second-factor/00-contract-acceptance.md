...
- Modify `docs/adr/0049-totp-second-factor-authentication.md` and
  `docs/adr/README.md`.
- Own `docs/design/passkey-second-factor-contract.md` for the v0.4.6 note that
...
- Modify `docs/plans/totp-second-factor.md` only to mark its contract
  prerequisite satisfied and record the accepted base commit.
...
- Make API and security design name the new fields, methods, routes, key ring,
  ...
  budget, attempt-mail cap, mail events, older-client behavior, and v0.4.6 floor
...
- Add acceptance rows for TOTP profile and replay, encrypted storage and
  ...
  versions, bilingual UI and mail, and floor 4006.
