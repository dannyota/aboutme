...
- Modify `docs/adr/0049-totp-second-factor-authentication.md` and
  `docs/adr/README.md`.
- Own `docs/design/passkey-second-factor-contract.md` for the v0.4.7 note that
...
- Make API and security design name the new fields, methods, routes, key ring,
  ...
  budget, attempt-mail cap, mail events, older-client behavior, and v0.4.7 floor
...
- Add acceptance rows for TOTP profile and replay, encrypted storage and
  ...
  versions, bilingual UI and mail, and floor 4007.
