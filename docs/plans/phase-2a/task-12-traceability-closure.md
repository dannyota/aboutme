...
- [x] **Step 1:** fill test references for AC-DOC-001 (trigger + store + Suite A
...
- [x] **Step 2:** hand the integration owner, in one report: (a) any owner-only
...
- [x] **Step 3: gate.** `make docs-fmt && make docs-lint`.
- [x] **Step 4: handoff.** Report the exact owned diff and gate output without
