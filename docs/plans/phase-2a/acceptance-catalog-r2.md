...
0011, and treats the bounds matrix as author TDD rather than a third blind
suite.
...
| P2A-R2-10 | Independent suites A and B retain author independence and pass their specified race gates           | AC-DOC-001/010, AC-SAVE-003        |
