...
- [x] Recommend UAT resource sizes, storage/backup settings, test duration, and
      separate production assumptions. Explain how they fit the measured
      workload and the comparison's trade-offs.
- [x] Give expected and upper-bound scenario costs, a proposed spending ceiling,
...
- [x] Inventory the owner's SES handoff and missing deployment inputs without
...
- [x] Account for OpenTofu adoption of the existing `aboutme-email` stack,
      ...
      resources.
- [x] Update Phase 10 contracts, including any architecture ADR, regional/global
