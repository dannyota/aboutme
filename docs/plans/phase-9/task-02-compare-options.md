...
- [x] Compare the ECS-on-EC2/RDS/S3 baseline with managed AWS alternatives,
...
- [x] Prefer ARM64/Graviton where compatible. Check every runtime image and
