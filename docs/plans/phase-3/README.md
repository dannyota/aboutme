...
**Traceability:** `../traceability/` rows **AC-SEC-001** (hostile corpus),
...
This plan is split across the files below; each section's text is unchanged from
the single-file version it was split from.
...
| [`task-00-batch-web-dependencies.md`](task-00-batch-web-dependencies.md)     | Task 0: Batch web dependency additions (single owner — B8)                                      |
| [`task-01-sanitizer-codegen.md`](task-01-sanitizer-codegen.md)               | Task 1: Sanitizer allowlist + hostile corpus codegen                                            |
| [`task-02-go-write-path-sanitizer.md`](task-02-go-write-path-sanitizer.md)   | Task 2: Go write-path sanitizer (`apps/server/internal/sanitize`)                               |
| [`task-03-client-render-sanitizer.md`](task-03-client-render-sanitizer.md)   | Task 3: Client-side render sanitizer (DOMPurify, browser-only) + cross-implementation agreement |
| [`task-04-blind-adversarial-suites.md`](task-04-blind-adversarial-suites.md) | Task 4: Blind adversarial sanitizer + render-bounds suites (independent author)                 |
| [`task-05-self-hosted-fonts.md`](task-05-self-hosted-fonts.md)               | Task 5: Self-hosted Vietnamese-diacritic fonts                                                  |
| [`task-06-renderer-core.md`](task-06-renderer-core.md)                       | Task 6: Renderer core (continuous mode)                                                         |
| [`task-07-pagination.md`](task-07-pagination.md)                             | Task 7: Pagination — pure engine + editor paged mode                                            |
| [`task-08-template-presets.md`](task-08-template-presets.md)                 | Task 8: Template presets + registry + apply — ADR 0008 gate satisfied                           |
| [`task-09-golden-snapshot-harness.md`](task-09-golden-snapshot-harness.md)   | Task 9: Golden snapshot harness (both modes × templates × fixtures)                             |
| [`task-10-import-lint-rule.md`](task-10-import-lint-rule.md)                 | Task 10: Editor→renderer one-way import lint rule + purity lint                                 |
| [`task-11-playwright-harness.md`](task-11-playwright-harness.md)             | Task 11: Playwright harness — visual regression, offline fonts, browser corpus + CSP            |
