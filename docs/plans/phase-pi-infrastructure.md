...
in [`traceability.md`](traceability.md); PI sequencing and status are recorded
...
[`traceability.md`](traceability.md), and **AC-OPS-015…019** are the P9A-owned
...
[`implementation-plan.md`](implementation-plan.md); no companion patch file is
required or present.
