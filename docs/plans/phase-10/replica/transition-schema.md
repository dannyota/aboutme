...
- [ ] Add a failing object-existence test using the existing
...
- [ ] Run the focused race command below before creating migration 16. Record
...
- [ ] Add the four tables, immediate restrictive foreign keys, supporting
...
- [ ] Add failing cases before each constraint or assertion that they exercise.
...
- [ ] Prove the exact parent matrix field by field: every required null fails,
...
- [ ] Prove target count 1..4, nil IDs, duplicate discovery/resume, ordinal
...
- [ ] Prove complete results for committed parents and all-null results for
...
- [ ] Prove deferred checks on initial closing creation and later updates. Force
...
- [ ] Use two pinned connections to race terminalization against child insert
...
- [ ] Prove all four no-TRUNCATE guards under valid owner write entry, including
...
- [ ] Prove a version-15 database containing membership, lifecycle and business
...
- [ ] Inspect the owned diff and report exact red/green evidence, tables and
