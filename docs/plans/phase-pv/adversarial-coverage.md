...
| Stamp motion ignores reduced motion           | Stamp and shell tests with `matchMedia('(prefers-reduced-motion: reduce)')` mocked true assert no animation attribute and immediate mark presence        | T09                |
