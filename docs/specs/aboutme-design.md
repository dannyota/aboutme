...
| Area                                                        | v1                                                                                                                                                                                                                                                                                                                                                                                  |
| ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Editor                                                      | Multi-resume (**max 3 per user**); typed sections (a closed set of exactly eight: profile, work, education, skill, language, certificate, project, custom — §3's table and `resume.schema.json` are the authority; open-ended needs go through `custom`); ProseMirror rich text (sanitized HTML); customization (fonts, colors, 1–2 column layout, spacing, headings); templates    |
