...
silently rejected the new type at runtime: three languages disagreeing, with the
drift test never catching it because nothing forced the generator's list to
track the schema.
