...
supersession record; these pages state the resulting design. ADRs 0014–0019 and
0021–0023 are proposed with Draft v4 and require explicit acceptance.
...
| [0021](../adr/0021-template-placement-order.md)     | Proposed | Validate exact placement; order by selector then current position |
| [0022](../adr/0022-public-artifact-revocation.md)   | Proposed | Revalidate every public reuse; fence and drain generation leases  |
| [0023](../adr/0023-private-print-capability.md)     | Proposed | One-use 256-bit, 60-second capability bound to snapshot and job   |

## Open approval gates

| Gate                                                          | Accountable owner                         | Deadline                                                       |
| ------------------------------------------------------------- | ----------------------------------------- | -------------------------------------------------------------- |
| Draft v4 dated approval                                       | Design owner                              | Before P3 Task 5 or any later P3 contract consumer starts      |
| Template contract dated approval                              | Design owner                              | Before P3 Task 6 or Task 8 starts                              |
| Exact font-byte, license, notice, and Reserved Font Name gate | Design owner                              | Before each P3 Task 5 asset is admitted and before Task 5B     |
| ADR 0014 acceptance                                           | Design owner                              | Before Draft v4 approval; no later than P3 Task 5 dispatch     |
| ADR 0015 acceptance                                           | Design owner                              | Before Draft v4 approval; no later than P3 Task 5 dispatch     |
| ADR 0016 acceptance                                           | Design owner                              | Before Draft v4 approval; no later than P3 Task 5 dispatch     |
| ADR 0017 acceptance                                           | Design owner                              | Before Draft v4 approval; no later than P3 Task 5 dispatch     |
| ADR 0018 acceptance                                           | Design owner                              | Before Draft v4 approval; no later than P3 Task 5 dispatch     |
| ADR 0019 acceptance                                           | Design owner                              | Before Draft v4 approval; no later than P3 Task 5 dispatch     |
| ADR 0021 acceptance                                           | Design owner                              | Before Draft v4 approval and before P3 Task 6 or Task 8 starts |
| ADR 0022 acceptance                                           | Design owner                              | Before Draft v4 approval; no later than P3 Task 5 dispatch     |
| ADR 0023 acceptance                                           | Design owner                              | Before Draft v4 approval; no later than P3 Task 5 dispatch     |
| Product name and trademark review                             | Human owner                               | Before P10 production promotion begins                         |
| Privacy and disclosure review                                 | Qualified privacy counsel and human owner | Before P10 production promotion begins                         |
